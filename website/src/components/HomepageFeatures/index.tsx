...
type FeatureItem = {
  ...
  theme: keyof typeof themeClassMap;
};
...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        ...
        powered by Bubble Tea and Fang.
      </>
    ),
    theme: 'primary',
  },
  {
    ...
    description: (
      <>
        Organize your tasks with projects, priorities, tags, contexts, due
        dates, and recurrence—all from a single CLI.
      </>
    ),
    theme: 'danger',
  },
  {
    ...
    description: (
      <>
        Sync Markdown notes with leaflet.pub, push updates over AT Protocol, and
        manage drafts without leaving the terminal.
      </>
    ),
    theme: 'accent',
  },
  {
    ...
    description: (
      <>
        Capture the clean content of any article, store Markdown + HTML copies,
        and enjoy a terminal reader inspired by Readability.
      </>
    ),
    theme: 'warning',
  },
  {
    ...
    description: (
      <>
        ...
        with tags, IDs, and shared metadata.
      </>
    ),
    theme: 'info',
  },
  {
    ...
    description: (
      <>
        Built in the open on GitHub under the MIT license. Fork it, extend it,
        and make Noteleaf part of your own workflows.
      </>
    ),
    theme: 'plum',
  },
